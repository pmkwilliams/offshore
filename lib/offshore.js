var _ = require('lodash'),
    ...
    Connections = require('./offshore/connections'),
    CollectionLoader = require('./offshore/collection/loader'),
    COLLECTION_DEFAULTS = require('./offshore/collection/defaults'),
    hasOwnProperty = require('./offshore/utils/helpers').object.hasOwnProperty;
